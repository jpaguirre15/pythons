...
'''
Description: Your objective is to write a script in Python 3 to convert variable “int1” as a string data type. Then combine both “str1” and “int1” together to create a whole string. Complete task when ready.
